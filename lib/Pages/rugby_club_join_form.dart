...
class RugbyClubJoinForm extends StatelessWidget {
  const RugbyClubJoinForm({super.key, required String inputText});
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      width: 130,
                      //color: Colors.white,
                      child: Image.asset("assets/rugby_logo.jpg",
                      height: 90,
                      width: 50,
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Rugby", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 50),)),
                          ),
