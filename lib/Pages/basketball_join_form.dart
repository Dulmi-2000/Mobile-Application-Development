...
class BasketballClubJoinForm extends StatelessWidget {
  const BasketballClubJoinForm({super.key, required String inputText});
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      width: 130,
                      //color: Colors.white,
                      child: Image.asset("assets/netball_logo.png",
                      height: 90,
                      width: 50,
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Basketball", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 40),)),
                          ),
