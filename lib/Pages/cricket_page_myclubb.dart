...
//import 'package:npaly_application/Pages/cricket_club_join_form.dart';

class AfterCricketpage extends StatelessWidget {
  const AfterCricketpage({super.key, required String inputText});
                          ...
                          child: Column(
                            ...
                            children: [
                              Align(
                                  ...
                                  child: Text("     "
                                      "\u2022"
                                      "  Male Captain – Kasun Perera")),
                              Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text("     "
                                      "\u2022"
                                      "  Female Captain – Nisini De Silva")),
                              Align(
                                  alignment: Alignment.bottomLeft,
                                  child: Text("     "
                                      "\u2022"
