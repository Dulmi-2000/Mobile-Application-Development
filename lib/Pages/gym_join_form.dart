...
class GymJoinForm extends StatelessWidget {
  const GymJoinForm({super.key, required String inputText});
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Gymnasium", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 35),)),
                          ),
