...
import 'package:npaly_application/Pages/gym_join_form.dart';

class GymPage extends StatelessWidget {
  const GymPage({super.key, required String inputText});
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const GymJoinForm(
                                  inputText: '',
                                ),
                              ),
                            );
