...
class CricketClubJoinForm extends StatelessWidget {
  const CricketClubJoinForm({super.key, required String inputText});
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Cricket", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 50),)),
                          ),
