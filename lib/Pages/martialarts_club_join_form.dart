...
class MartialartsClubJoinForm extends StatelessWidget {
  const MartialartsClubJoinForm({super.key, required String inputText});
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      width: 130,
                      //color: Colors.white,
                      child: Image.asset("assets/martialarts_logo.png",
                      height: 90,
                      width: 50,
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Athletics", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 50),)),
                          ),
