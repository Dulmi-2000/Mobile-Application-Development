...
class AthleticClubJoinForm extends StatelessWidget {
  const AthleticClubJoinForm({super.key, required String inputText});
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      width: 130,
                      //color: Colors.white,
                      child: Image.asset("assets/Athletic_logo.png",
                      height: 90,
                      width: 50,
                      ),
                    ),
