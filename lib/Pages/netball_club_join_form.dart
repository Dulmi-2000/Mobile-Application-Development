...
class NetballClubJoinForm extends StatelessWidget {
  const NetballClubJoinForm({super.key, required String inputText});
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Netball", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 50),)),
                          ),
