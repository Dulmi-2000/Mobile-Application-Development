           ...
           child: Container(
              ...
              Column(
                ...
                children: [
                  ...
                  Align(
                    child: Text("USe this QR Code to mark yor attendance",
                    style: TextStyle(
                      fontSize: 17,
                      fontWeight: FontWeight.w600,
                    ),),
                     ...
                     Align(
                      alignment: Alignment.centerLeft,
                       child: Padding(
                        ...
                        Text("You can mark this QR code only with university WiFi.\n This QR code is valid only for 15 mins.",
                                     style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: Colors.red,
              ...
              child: ElevatedButton(
                onPressed:() {
                    ...
                    ///
                           ...
                           MaterialPageRoute(builder: (context) =>  const TodayAttendanceEvents(inputText: '',)),);
