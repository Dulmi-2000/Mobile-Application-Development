...
class BadmintonResrvationPage extends StatefulWidget {
  const BadmintonResrvationPage({super.key});

  @override
  State<BadmintonResrvationPage> createState() =>
      _BadmintonResrvationPageState();
}

class _BadmintonResrvationPageState extends State<BadmintonResrvationPage> {
