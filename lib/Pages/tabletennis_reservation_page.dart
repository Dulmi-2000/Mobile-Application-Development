...
class TableTennisResrvationPage extends StatefulWidget {
  const TableTennisResrvationPage({super.key});

  @override
  State<TableTennisResrvationPage> createState() =>
      _TableTennisResrvationPageState();
}

class _TableTennisResrvationPageState extends State<TableTennisResrvationPage> {
          ...
          leading: IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const RecReservationPage(),
                ),
              );
            },
