...
class VolleyballClubJoinForm extends StatelessWidget {
  const VolleyballClubJoinForm({super.key, required String inputText});
                ...
                Row(
                  children: [
                    SizedBox(
                      ...
                      width: 130,
                      //color: Colors.white,
                      child: Image.asset("assets/volleyball_logo.jpg",
                      height: 90,
                      width: 50,
                      ),
                    ),
                      ...
                      child: Column(
                        children: [
                          Padding(
                            ...
                            child: Center(child: Text("Volleyball", style: TextStyle(fontWeight: FontWeight.w400,fontSize: 40),)),
                          ),
