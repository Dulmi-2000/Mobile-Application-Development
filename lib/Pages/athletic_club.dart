...
import 'package:npaly_application/Pages/athletic_club_join_form.dart';

class Athleticpage extends StatelessWidget {
  const Athleticpage({super.key, required String inputText});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Athletic Club"),
