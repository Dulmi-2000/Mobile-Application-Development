...
import 'package:npaly_application/Pages/chess_club_join_form.dart';

class Chesspage extends StatelessWidget {
  const Chesspage({super.key, required String inputText});
                          ...
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => const ChessClubJoinForm(
                                    inputText: '',
                                  ),
                                ),
                              );
